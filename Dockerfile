...
CMD sh -c "python manage.py migrate && \
           ...
           python -c 'import gevent; print(gevent.__version__)' && gunicorn your_project_name.wsgi:application --bind 0.0.0.0:$PORT --worker-class gevent --workers 2 --timeout 60""
